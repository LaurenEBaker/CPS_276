...
$elementsArr = [
  ...
  "city"=>[
   ...
   "state"=>[
    "type"=>"select",
    "options"=>["mi"=>"Michigan","oh"=>"Ohio","fl"=>"Florida","tx"=>"Texas", "ak"=>"Alaska"],
		"selected"=>"mi",
		"regex"=>"state"
	],
	"phone"=>[
  ...
  "contact"=>[
    "type"=>"ratio",
    "action"=>"notRequired",
    "status"=>["Newspaper"=>"", "Text Update"=>"", "Email Update"=>""]
  ],
  "age"=>[
    "errorMessage"=>"<span style='color: red; margin-left: 15px;'>You must select your age range</span>",
    "errorOutput"=>"",
    "action"=>"required",
    "type"=>"checkbox",
...
function addData($post){
  ...
  /* IF EVERYTHING WORKS ADD THE DATA HERE TO THE DATABASE HERE USING THE $_POST SUPER GLOBAL ARRAY */
      ...
      $sql = "INSERT INTO contactMod (name, address, city, state, phone, email, dob, contact, age) VALUES (:name, :address, :city, :state, :phone, :email, :dob, :contact, :age)";
...
$form = <<<HTML
    ...
    <div class="form-group">
      <label for="dob">Date of Birth{$elementsArr['city']['errorOutput']}</label>
    ...
    <div class="form-check form-check-inline">
      <input class="form-check-input" type="checkbox" name="contact[]" id="contact1" value="Newspaper"  {$elementsArr['contact']['status']['Newspaper']}>
      <label class="form-check-label" for="contact1">Newspaper</label>
    </div>

    <div class="form-check form-check-inline">
      <input class="form-check-input" type="checkbox" name="contact[]" id="contact2" value="Text Update"  {$elementsArr['contact']['status']['Text Update']}>
      <label class="form-check-label" for="contact2">Text Updates</label>
    </div>

    <div class="form-check form-check-inline">
      <input class="form-check-input" type="checkbox" name="contact[]" id="contact3" value="Email Update"  {$elementsArr['contact']['status']['Email Update']}>
      <label class="form-check-label" for="contact3">Email Updates</label>
    </div>        
