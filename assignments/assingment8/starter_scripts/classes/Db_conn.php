...
class DatabaseConn {	
  ...
  public function dbOpen(){
    ...
    try {
      ...
      $dbHost = 'localhost';
      $dbName = 'lebaker';//this will be your WCC username
      $dbUsr = 'lebaker';//this will be your WCC username
      $dbPass = 'qY67kZ95Ke5y';//this will be the password found in the video.
